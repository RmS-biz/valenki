			...
			$str_ancor =				'
				<table>
					<tr>
						...
						<td><a href="#price"> <img src="/img-min/scroll-min.png"></a></td>
					</tr>
				</table>';
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<link rel="icon" href="/img-min/favicon.ico" type="image/x-icon">
				...
				<table class="lp-block3-table">
					<tr>
						<td class="lp-block3-left">
							<img src="img-min/block1-img-min.jpg" alt="" />
...
<fieldset>
	...
	<table class="lp-wrapper2">
		...
		<tr class="lp-lend2-2">
			<td class="lp-lend2-content1"><img src="img-min/block2-img1-min.png" alt="" /></td>
			<td colspan="2" class="lp-lend2-content2">Бабушки и дедушки <br />
<span>(полуваленки легко снимать и одевать)</span><br />
<img src="img-min/block2-img2-min.png" alt="" /></td>
		</tr>
		<tr class="lp-lend2-2">
			<td class="lp-lend2-content1"><img src="img-min/block2-img3-min.png" alt="" /></td>
			<td colspan="2" class="lp-lend2-content2">Детишки, особенно грудного возраста <br />
<span>(натуральные валенки греют ножки в коляске в любой мороз)</span><br /><img src="img-min/block2-img4-min.png" alt="" /></td>
		</tr>
		<tr class="lp-lend2-2">
			<td class="lp-lend2-content1"><img src="img-min/block2-img5-min.png" alt="" /></td>
			<td colspan="2" class="lp-lend2-content2">Любители природы и свежего воздуха<br />
<span>(идеально для частного дома, рыболовов и собаководов)</span><br /><img src="img-min/block2-img6-min.png" alt="" /></td>
		</tr>
		<tr class="lp-lend2-2">
			<td class="lp-lend2-content1"><img src="img-min/block2-img7-min.png" alt="" /></td>
			<td colspan="2" class="lp-lend2-content2">Толстые люди с проблемами ног <br />
<span>(изготовим валенки по вашим меркам для каждой из ног)</span><br /><img src="img-min/block2-img8-min.png" alt="" /></td>
		</tr>
	</table>
	...
	<table class="lp-wrapper2">
		...
		<tr>
			<td class="lp-land-content1"><img src="img-min/block4-img1-min.jpg" alt="" /></td>
...
рисунком</span></td>
			<td class="lp-land-content3"><img src="img-min/block4-img2-min.jpg" alt="" /></td>
		</tr>
	</table>
	...
	<table class="lp-wrapper3">
		...
		<tr>
			...
			<h2>Что вы получаете за эту цену?</h2>
				<table>
				<tr class="lp-lend3-2">
					<td class="lp-lend3-content1"><img src="img-min/block3-img3-min.png" alt="" /></td>
					<td colspan="2" class="lp-lend3-content2">Доставку в день заказа<span> (согласуйте с менеджером)</span></td>
				</tr>
				<tr class="lp-lend3-2">
					<td class="lp-lend3-content1"><img src="img-min/block3-img2-min.png" alt="" /></td>
				...
				<tr class="lp-lend3-2">
					<td class="lp-lend3-content1"><img src="img-min/block3-img1-min.png" alt="" /></td>
					<td colspan="2" class="lp-lend3-content2">90 дней на обмен<span> (вместо 7 дней по Закону,  без лишних вопросов)</span></td>
				</tr>
				<tr class="lp-lend3-2">
					<td class="lp-lend3-content1"><img src="img-min/block3-img5-min.png" alt="" /></td>
				...
				<tr class="lp-lend3-2">
					<td class="lp-lend3-content1"><img src="img-min/block3-img8-min.png" alt="" /></td>
	...
	<table class="lp-wrapper2" border="1">
		...
		<tr>
			<td class="lp-block9-content2"><img src="img-min/block9-img1-min.png" alt="" /></td>
...
такого "теплого" сайта.
		...
		<tr>
			<td class="lp-block9-content2"><img src="img-min/block9-img2-min.png" alt="" /></td>
			<td colspan="2" class="lp-block9-content">
		...
		<tr>
			<td class="lp-block9-content2"><img src="img-min/block9-img3-min.png" alt="" /></td>
			<td colspan="2" class="lp-block9-content">
...
<br /><br />
<img src="img-min/block9-img4-min.jpg" alt="" /></td>
		</tr>
	</table>
	...
	<table class="lp-wrapper2">
		...
		<tr class="lp-block8-content">
			<td><img src="img-min/block8-img1-min.png" alt="" /></td>
			<td><img src="img-min/block8-img2-min.png" alt="" /></td>
			<td><img src="img-min/block8-img3-min.png" alt="" /></td>
		</tr>
		<tr>
			<td class="lp-block8-title" colspan="3">Два снегиря</td>
		</tr>
		<tr class="lp-block8-content">
			<td><img src="img-min/block8-img4-min.png" alt="" /></td>
			<td><img src="img-min/block8-img5-min.png" alt="" /></td>
			<td><img src="img-min/block8-img6-min.png" alt="" /></td>
		</tr>
		<tr>
			<td class="lp-block8-title" colspan="3">Золотой</td>
		</tr>
		<tr class="lp-block8-content">
			<td><img src="img-min/block8-img7-min.png" alt="" /></td>
			<td><img src="img-min/block8-img8-min.png" alt="" /></td>
			<td><img src="img-min/block8-img9-min.png" alt="" /></td>
		</tr>
		<tr>
			<td class="lp-block8-title" colspan="3">Орел</td>
		</tr>
		<tr class="lp-block8-content">
			<td><img src="img-min/block8-img10-min.png" alt="" /></td>
			<td><img src="img-min/block8-img11-min.png" alt="" /></td>
			<td><img src="img-min/block8-img12-min.png" alt="" /></td>
		</tr>
		<tr>
			<td class="lp-block8-title" colspan="3">Панда</td>
		</tr>
		<tr class="lp-block8-content">
			<td><img src="img-min/block8-img13-min.png" alt="" /></td>
			<td><img src="img-min/block8-img14-min.png" alt="" /></td>
			<td><img src="img-min/block8-img15-min.png" alt="" /></td>
		</tr>
		<tr>
			<td class="lp-block8-title" colspan="3">Розы</td>
		</tr>
		<tr class="lp-block8-content">
			<td><img src="img-min/block8-img16-min.png" alt="" /></td>
			<td><img src="img-min/block8-img17-min.png" alt="" /></td>
			<td><img src="img-min/block8-img18-min.png" alt="" /></td>
		</tr>
		<tr>
			<td class="lp-block8-title" colspan="3">Сакура</td>
		</tr>
		<tr class="lp-block8-content">
			<td><img src="img-min/block8-img19-min.png" alt="" /></td>
			<td><img src="img-min/block8-img20-min.png" alt="" /></td>
			<td><img src="img-min/block8-img21-min.png" alt="" /></td>
		</tr>
		<tr>
			<td class="lp-block8-title" colspan="3">Японский сад</td>
		</tr>
		<tr class="lp-block8-content">
			<td><img src="img-min/block8-img22-min.png" alt="" /></td>
			<td><img src="img-min/block8-img23-min.png" alt="" /></td>
			<td><img src="img-min/block8-img24-min.png" alt="" /></td>
		</tr>
		<tr>
			<td class="lp-block8-title" colspan="3">Ваша фантазия <span>(нарисуем любую картинку)</span></td>
		</tr>
		<tr class="lp-block8-content">
			<td><img src="img-min/block8-img25-min.png" alt="" /></td>
			<td><img src="img-min/block8-img26-min.png" alt="" /></td>
			<td><img src="img-min/block8-img27-min.png" alt="" /></td>
		</tr>
	</table>
...
<?	/*		<tr class="lp-lend3-2">
			<td class="lp-lend3-content1"><img src="img-min/block3-img6-min.png" alt="" /></td>
...
<?	/*		<tr class="lp-lend3-2">
		...
		<tr class="lp-lend3-2">
			<td class="lp-lend3-content1"><img src="img-min/block3-img9-min.png" alt="" /></td>
			<td colspan="2" class="lp-lend3-content2">Красиво <span>(нанесение рисунка художником разными технологиями)</span></td>
		</tr>
		<tr class="lp-lend3-2">
			<td class="lp-lend3-content1"><img src="img-min/block3-img10-min.png" alt="" /></td>
	...
	<table class="lp-wrapper2">
		...
		<tr class="lp-block5-content">
			<td><img src="img-min/block5-img1-min.png" alt="" /></td>
			<td><img src="img-min/block5-img2-min.png" alt="" /></td>
			<td><img src="img-min/block5-img3-min.png" alt="" /></td>
			<td><img src="img-min/block5-img4-min.png" alt="" /></td>
		</tr>
		<tr>
		...
		<tr class="lp-block5-content">
			<td colspan="4" class="lp-block5-content2">
				<ul>
					<li><img src="img-min/block5-img5-min.png" alt="" /></li>
					<li><img src="img-min/block5-img6-min.png" alt="" /></li>
					<li><img src="img-min/block5-img7-min.png" alt="" /></li>
				</ul>
			</td>
		</tr>
		<tr>
		...
		<tr class="lp-block5-content">
			<td colspan="4" class="lp-block5-content2">
				<ul>
					<li><img src="img-min/block5-img8-min.png" alt="" /></li>
					<li><img src="img-min/block5-img9-min.png" alt="" /></li>
				</ul>
			</td>
		</tr>
		<tr>
		...
		<tr class="lp-block5-content">
			<td><img src="img-min/block5-img10-min.png" alt="" /></td>
			<td><img src="img-min/block5-img11-min.png" alt="" /></td>
			<td><img src="img-min/block5-img12-min.png" alt="" /></td>
			<td><img src="img-min/block5-img13-min.png" alt="" /></td>
		</tr>
		<tr class="lp-block5-content">
			<td><img src="img-min/block5-img14-min.png" alt="" /></td>
			<td><img src="img-min/block5-img15-min.png" alt="" /></td>
			<td><img src="img-min/block5-img16-min.png" alt="" /></td>
			<td><img src="img-min/block5-img17-min.png" alt="" /></td>
		</tr>
		<tr>
		...
		<tr class="lp-block5-content">
			<td colspan="4" class="lp-block5-content2">
				<ul>
					<li><img src="img-min/block5-img18-min.png" alt="" /></li>
					<li><img src="img-min/block5-img19-min.png" alt="" /></li>
					<li><img src="img-min/block5-img20-min.png" alt="" /></li>
				</ul>
			</td>
		</tr>
	</table>
...
<span>Для заказа валенок с узором, просто сообщите менеджеру номер узора и желаемый цвет <br> (красный, белый, синий, черный)</span></td>
		...
		<tr class="lp-block6-content">
			<td><img src="img-min/block6-img1-min.png" alt="" /></td>
			<td><img src="img-min/block6-img2-min.png" alt="" /></td>
			<td><img src="img-min/block6-img3-min.png" alt="" /></td>
		</tr>
		<tr class="lp-block6-content">
			<td><img src="img-min/block6-img4-min.png" alt="" /></td>
			<td><img src="img-min/block6-img5-min.png" alt="" /></td>
			<td><img src="img-min/block6-img6-min.png" alt="" /></td>
		</tr>
		<tr class="lp-block6-content">
			<td><img src="img-min/block6-img7-min.png" alt="" /></td>
			<td><img src="img-min/block6-img8-min.png" alt="" /></td>
			<td><img src="img-min/block6-img9-min.png" alt="" /></td>
		</tr>
		<tr class="lp-block6-content">
			<td><img src="img-min/block6-img10-min.png" alt="" /></td>
			<td><img src="img-min/block6-img11-min.png" alt="" /></td>
			<td><img src="img-min/block6-img12-min.png" alt="" /></td>
		</tr>
		<tr class="lp-block6-content">
			<td><img src="img-min/block6-img13-min.png" alt="" /></td>
			<td><img src="img-min/block6-img14-min.png" alt="" /></td>
			<td><img src="img-min/block6-img15-min.png" alt="" /></td>
		</tr>
	</table>
	...
	<table class="lp-wrapper2">
		...
		<tr class="lp-block7-content">
			<td><img src="img-min/block7-img1-min.png" alt="" /></td>
			<td><img src="img-min/block7-img2-min.png" alt="" /></td>
			<td><img src="img-min/block7-img3-min.png" alt="" /></td>
		</tr>
		<tr>
			<td class="lp-block7-title" colspan="3">IT Park <span>(Казань)</span></td>
		</tr>
		<tr class="lp-block7-content">
			<td><img src="img-min/block7-img4-min.png" alt="" /></td>
			<td><img src="img-min/block7-img5-min.png" alt="" /></td>
			<td><img src="img-min/block7-img6-min.png" alt="" /></td>
		</tr>
	</table>
	...
	Изготовим индивидуальные валенки специально для вас.</td>
			...
			<tr>
				<td class="lp-block10-content1" colspan="3"><img src="img-min/block10-img1-min.png" alt="" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="lp-block10-content2" colspan="3">
					<ul>
						<li><img src="img-min/block10-img2-min.jpg" alt="" /></li>
				...
				<td colspan="3">
					<table class="lp-block10-content4">
						<tr>
							<td>
								<ul>
									<li><img src="img-min/block10-img3-min.png" alt="" /><span>белый</span></li>
									<li><img src="img-min/block10-img4-min.png" alt="" /><span>серый</span></li>
									<li><img src="img-min/block10-img5-min.png" alt="" /><span>черный</span></li>
									<li><img src="img-min/block10-img6-min.png" alt="" /><span>комбинированный</span></li>
								</ul>
							</td>
							<td class="lp-block10-content5"><img src="img-min/block10-img7-min.jpg" alt="" /></td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr class="lp-block10-content6">
				<td><img src="img-min/block10-img8-min.png" alt="" /></td>
				<td><img src="img-min/block10-img9-min.png" alt="" /></td>
				<td><img src="img-min/block10-img10-min.png" alt="" /></td>
			</tr>
			<tr>
	...
	<table class="lp-wrapper1">
		...
		<tr class="lp-block11-content">
			<td><img src="img-min/block11-img1-min.png" alt="" /></td>
			<td><img src="img-min/block11-img2-min.png" alt="" /></td>
			<td><img src="img-min/block11-img3-min.png" alt="" /></td>
		</tr>
		<tr class="lp-block11-content">
			<td><img src="img-min/block11-img4-min.png" alt="" /></td>
			<td><img src="img-min/block11-img5-min.png" alt="" /></td>
			<td><img src="img-min/block11-img6-min.png" alt="" /></td>
		</tr>
		<tr class="lp-block11-content">
			<td><img src="img-min/block11-img7-min.png" alt="" /></td>
			<td><img src="img-min/block11-img8-min.png" alt="" /></td>
			<td><img src="img-min/block11-img9-min.png" alt="" /></td>
		</tr>
	</table>
	...
	<table class="lp-wrapper1">
		...
		<tr class="lp-block12-content">
			<td><img src="img-min/block12-img1-min.jpg" alt="" /></td>
			<td class="lp-block12-content1"><img src="img-min/block12-img2-min.jpg" alt="" /><br /><br /><br /><br /><br />наложенный платеж<br /> <br /><span>+5% к стоимости товара<br />
         (комиссия Почты России)</span></td>
			<td class="lp-block12-content2"><img src="img-min/block12-img3-min.jpg" alt="" /><br />наличными курьеру</td>
		</tr>
	</table>
	<table class="lp-wrapper2">
		<tr>
		...
		<tr class="lp-block13-content">
			...
			<td class="lp-block13-content2">по России
				<ul>
					<li><img src="img-min/block13-img2-min.jpg" alt="" /><p>Бесплатно<br />
<span>(предоплата)</span></p></li>
					<li><img src="img-min/block13-img3-min.jpg" alt="" /><p>1 классом<br />
<span>(ускоренная)</span></p></li>
					<li><img src="img-min/block13-img4-min.jpg" alt="" /><p>Экспресс<br />
<span>(до двери)</span></p></li>
				</ul>
			</td>
			<td class="lp-block13-content3"><img src="img-min/block13-img5-min.jpg" alt="" /></a>
</td>
		</tr>
	</table>
